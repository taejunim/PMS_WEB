...
import metis.app.pmsWeb.logging.AXBootLogbackMdcFilter;
import metis.app.pmsWeb.security.*;
...
public class AXBootSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/api/updateLogoutAll").permitAll()
                .and()
                ...
                .addFilterBefore(new AXBootLoginFilter(LOGIN_API, tokenAuthenticationService, userDetailsService, authenticationManager(), new AXBootAuthenticationEntryPoint()), UsernamePasswordAuthenticationFilter.class)
