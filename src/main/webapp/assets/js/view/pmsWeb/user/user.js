...
fnObj.pageStart = function () {
    ...
    axboot
        .call({
            ...
            callback: function (res) {
                var userRole = [
                    {roleCd: "STAFF", roleNm: "직원", text: "직원(STAFF)", value: "STAFF"},
                    {roleCd: "DRIVER", roleNm: "배송기사", text: "배송기사(DRIVER)", value: "DRIVER"}];
...
fnObj.formView01 = axboot.viewExtend(axboot.formView, {
    ...
    getData: function () {
        ...
        data.grpAuthCd = $("input:radio[name='grpAuthCd']:checked").val();

        data.menuGrpCd = "MANAGER";
