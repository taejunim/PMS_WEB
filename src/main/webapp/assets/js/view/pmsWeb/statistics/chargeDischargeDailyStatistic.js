...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        ...
        if(searchDate.length != 10) return axToast.push("검색 일자를 설정하여 주십시오.");
        axboot.ajax({
            type: "GET",
            url: ["/chargeDischargeStatistic", "dailyList"],
    ...
    EXCEL_EXPORT: function (caller, act, data) {
        var fileName = "충방전일간통계_" + date + ".xls";
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: "label", label: "통계 시간", width: 160, align: "center"},
