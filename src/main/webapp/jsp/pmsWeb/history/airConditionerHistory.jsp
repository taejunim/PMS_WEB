...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/pmsWeb/history/airConditionerHistory.js' />"></script>
         <script>
        ...
        <div role="page-header">
            <ax:form name="searchView0" style="margin-bottom:0;">
                <ax:tbl clazz="ax-search-tbl" minWidth="500px">
                    <ax:tr>
                        <!--기간 선택-->
                        <ax:td label='ax.admin.airConditionerHistory.datePick' width="300px">
                            <div class="row">
                                <div class="col-md-9">
                        ...
                        <!--센서 구분-->
                        <ax:td label='ax.admin.airConditionerHistory.deviceCategorySub' width="300px">
                        ...
                        <ax:td label='ax.admin.airConditionerHistory.deviceCode' width="300px">
