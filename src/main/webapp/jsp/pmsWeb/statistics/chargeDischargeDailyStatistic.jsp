...
<ax:layout name="base">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/pmsWeb/statistics/chargeDischargeDailyStatistic.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:split-layout name="ax1" orientation="vertical">
                        <ax:form name="searchView0">
                            <ax:tbl clazz="ax-form-tbl">
                                <ax:tr>
                                    <ax:td label="ax.admin.chargeDischargeStatistic.searchDate" width="210px">
