...
<ax:layout name="base">
    ...
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/pmsWeb/statistics/chargeDischargeMonthlyStatistic.js' />"></script>
    </jsp:attribute>
    <jsp:body>
                ...
                <ax:split-layout name="ax1" orientation="vertical">
                        <ax:form name="searchView0">
                            <ax:tbl clazz="ax-form-tbl">
                                <ax:tr>
                                    <ax:td label="ax.admin.chargeDischargeStatistic.searchMonth" width="210px">
                                        <div class="input-group" data-ax5picker="grid1">
                                            <input type="text" name="searchDateFilter" id="searchDateFilter"
                                                   class="form-control"  data-picker-date="year" placeholder="yyyy/mm" style="width: 120px;" readonly>
