...
<ax:layout name="base">
    <jsp:attribute name="script">
        ...
        <script type="text/javascript" src="<c:url value='/assets/js/view/pmsWeb/user/user.js' />"></script>
    </jsp:attribute>
    <jsp:body>
            ...
            <ax:split-panel width="*" style="padding-left: 10px;" scroll="scroll">
                ...
                <ax:form name="formView01">
                    ...
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        <ax:tr labelWidth="120px">
                            ...
                            <ax:td label="ax.admin.user.id" width="220px">
                                <input type="text" id="userCd" name="userCd" data-ax-path="userCd" maxlength="20" title="아이디" class="av-required form-control W150" value=""/>
                            </ax:td>
                        </ax:tr>
                        <ax:tr labelWidth="120px">
                    ...
                    <ax:tbl clazz="ax-form-tbl">
                        <ax:tr>
                            <ax:td label="메뉴 설정" width="100%">
                                <label class="checkbox-inline"><input type="radio" name="menuGrpCd" data-ax-path="menuGrpCd" value="MANAGER" > 관리자용 메뉴</label>
                                <label class="checkbox-inline"><input type="radio" name="menuGrpCd" data-ax-path="menuGrpCd" value="USER" > 거래처용 메뉴 </label>

                                &lt;%&ndash;<select id="menuGrpCd" name="menuGrpCd" data-ax-path="menuGrpCd"  class="form-control">
                                    <option value="MANAGER">관리자용 메뉴</option>
                                    <option value="USER">거래처용 메뉴</option>
                                </select>&ndash;%&gt;
                            </ax:td>
                        </ax:tr>
                    </ax:tbl>--%>
                    ...
                    <ax:tbl clazz="ax-form-tbl">
                        <ax:tr>
                            <ax:td label="ax.admin.user.auth.group" width="100%">
                                <label class="checkbox-inline"><input type="radio" name="grpAuthCd" data-ax-path="grpAuthCd" value="S0002" > 관리자 </label>
                                <label class="checkbox-inline"><input type="radio" name="grpAuthCd" data-ax-path="grpAuthCd" value="S0004" > 직원 </label>
                            </ax:td>
                        </ax:tr>
                    </ax:tbl>
