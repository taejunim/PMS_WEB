...
<ax:layout name="base">
    ...
    <jsp:body>
        ...
        <ax:split-layout name="ax1" orientation="vertical">
            <ax:split-panel width="40%" style="padding-right: 10px;" childId="split-panel-grid-view-01">
                    ...
                    <ax:tbl clazz="ax-form-tbl" minWidth="500px">
                        <ax:tr labelWidth="120px">
                            ...
                            <ax:td label="ax.admin.user.id" width="220px">
                                <input type="text" name="userCd" data-ax-path="userCd" maxlength="20" title="아이디" class="av-required form-control W150" value=""/>
                            </ax:td>
                        </ax:tr>
                        <ax:tr labelWidth="120px">
                            <ax:td label="ax.admin.user.password" width="300px">
                                <input type="password" name="userPs" data-ax-path="userPs" maxlength="128" class="form-control W120" value="" />
                            </ax:td>
                            <ax:td label="ax.admin.user.password.confirm" width="460px">
                                <input type="password" name="userPs_chk" data-ax-path="userPs_chk" maxlength="128" class="form-control inline-block W120" value=""/>
                                &nbsp;
                                <label>
                        ...
                        <ax:tr labelWidth="120px">
                            ...
                            <ax:td label="중복로그인" width="220px" labelWidth="120px">
                                <button class="btn btn-danger" id="loginStatusChange2" onclick="logout()" disabled="disabled">로그아웃</button>
                            </ax:td>
                        </ax:tr>
                        <ax:tr labelWidth="120px">
